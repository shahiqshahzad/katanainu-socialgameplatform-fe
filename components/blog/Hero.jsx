...
import { FollowIcon, UserNeonIcon, VeryfiedIcon } from "../common/Icons";
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[14px] sm:text-[16px] text-white ">Team</p>
            </div>
          </div>
          <div className="flex items-center justify-center sm:justify-end flex-wrap-reverse  sm:flex-wrap gap-4 xl:gap-5">
            <div className="flex flex-col gap-y-2 2xl:w-[100px]">
              <div className="flex items-center gap-x-2">
                <div className="w-[20px] h-[20px] rounded-full border border-[#6C5DD3]">
                  <Image
                    src={"/images/flag.png"}
                    width={20}
                    height={20}
