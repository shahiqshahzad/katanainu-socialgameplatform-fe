...
import { getPastTournaments } from "../../utils/api/tournamentModule";
export const PastTournaments = () => {
  const { data: pastTournaments, isLoading } = getPastTournaments();
  ...
  return (
    ...
    >
      ...
      {pastTournaments?.data?.map((tournament, index) => (
        <div key={index}>
          <div
